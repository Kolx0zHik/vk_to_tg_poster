...
| видео | если VK отдаёт картинку `image`/`first_frame` — `sendPhoto` с превью, HTML-ссылкой на VK видео, статистикой и кнопкой; без картинки — текстовое сообщение с HTML-ссылкой |
